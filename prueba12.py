...
try:
    ...
    campo_buscar.click()
    campo_buscar.send_keys("perro salchicha, gordo bachicha")
    ...
    enviar_resultado_mantis("Buscar en el catálogo", "La página debe permitir buscar productos en el catálogo", 
                                "Se ingresó a la página" \
                                "-Se clickeó en el campo de búsqueda" \
                                "-Se ingresó el texto a buscar" \
                                , "la página permitió ingresar texto en el campo de búsqueda", "evidencia.png") 

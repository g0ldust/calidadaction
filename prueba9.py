...
try:
    ...
    if len(inputs) >= 2:
        ...
        enviar_resultado_mantis("Crear autos sin rellenar el campo modelo", "La página no debe permitir crear o editar un auto dejando el campo modelo vacío", 
                                "-se ingresó a la pagina" \
                                "-se ingresó el usuario y contraseña" \
                                "-se ingresaron los datos dejando el campo modelo vacío" \
                                "-la pagina no permitió guardar el auto", "la página no permitió crear o editar un auto dejando el campo modelo vacío")    
